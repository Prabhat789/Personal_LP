 ...
 */
public class PersonalTimeline extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_personal_timeline, container, false);
...
*/
    ...
    void receiveAllPost() {
        ...
        query.setLimit(50);
        query.whereEqualTo("userId", Utils.getUserId());
    ...
    /*void showDialog() {
        ...
        DialogFragment newFragment = PostDialogFragment1.newInstance();
        newFragment.show(ft, "");
    }*/
  ...
  /*  public static class PostDialogFragment1 extends DialogFragment implements ImageChooserListener, View.OnClickListener {
        ...
        private static PostDialogFragment1 f;
        private int audiance;
        private RadioGroup audianceGroup;

        static PostDialogFragment1 newInstance() {
            f = new PostDialogFragment1();
...
*/
   ...
   /* @Override
    ...
    void showDetailPostDialog(String url, String name, String detail) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        DialogFragment newFragment = DetailPostDialog1.newInstance();
    ...
    void showCommentsDialog(String oId) {
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        DialogFragment newFragment = CommentsDialog1.newInstance();
        Bundle bundle = new Bundle();
    ...
    public static class DetailPostDialog1 extends DialogFragment implements Animation.AnimationListener {
        ...
        static DetailPostDialog1 newInstance() {
            DetailPostDialog1 f = new DetailPostDialog1();
            f.setStyle(DialogFragment.STYLE_NORMAL, R.style.You_Dialog);
            return f;
        }
    ...
    public static class CommentsDialog1 extends DialogFragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {

        private static CommentsDialog1 f;
        ...
        static CommentsDialog1 newInstance() {
            f = new CommentsDialog1();
            f.setStyle(DialogFragment.STYLE_NORMAL, R.style.You_Dialog);
            return f;
        }
